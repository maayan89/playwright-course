...
export class PaymentPage {
    ...
    constructor(page) {
        ...
        this.discountActivateBtn = page.locator('[data-qa="submit-discount-button"]')
    ...
    activateDiscount = async () => {
        ...
        await this.discountActivateBtn.waitFor()
        await this.discountActivateBtn.click()
        // check that it desplays "Discount activated"
       ...
       // check that there is now a discounted price total showing
        ...
        // check that the discount price total is smaller than the regular one
